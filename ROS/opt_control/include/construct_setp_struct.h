...
extern void b_construct_setp_struct(const double t_in2[1], emxArray_real_T
  *J_setp_struct_time, emxArray_real_T *J_setp_struct_signals_values);
extern void c_construct_setp_struct(emxArray_real_T *J_setp_struct_time,
  emxArray_real_T *J_setp_struct_signals_values);
extern void construct_setp_struct(const double t_in2_data[], const int
  t_in2_size[2], const double J_in2_data[], const int J_in2_size[2], double
...
extern void d_construct_setp_struct(const emxArray_cell_wrap_0 *t_in2, const
